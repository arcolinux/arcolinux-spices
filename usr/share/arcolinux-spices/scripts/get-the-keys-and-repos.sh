...
sudo wget https://github.com/arcolinux/arcolinux_repo/raw/main/x86_64/arcolinux-mirrorlist-git-23.04-01-any.pkg.tar.zst -O /tmp/arcolinux-mirrorlist-git-23.04-01-any.pkg.tar.zst
sudo pacman -U --noconfirm --needed /tmp/arcolinux-mirrorlist-git-23.04-01-any.pkg.tar.zst
